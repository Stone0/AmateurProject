...
<div class="container demo-2">
	<div class="content">
		...
		<nav class="codrops-demos">
			<a href="<%=request.getContextPath() %>/jsp/AnimatedHeaderBackground/index.jsp">Demo 1</a>
...
<script src="<%=request.getContextPath() %>/js/AnimatedHeaderBackground/demo-2.js"></script>
</body>
</html>