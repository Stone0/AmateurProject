...
<head>
<meta charset="UTF-8">
<title>Canvas鼠标经过碎片高亮变化特效</title>

<script src="<%=request.getContextPath() %>/js/mouse_a/jrj6out.js"></script>
...
<script src="<%=request.getContextPath() %>/js/mouse_a/prefixfree.min.js"></script>
...
<script src='<%=request.getContextPath() %>/js/mouse_a/jquery.min.js'></script>
<script src='<%=request.getContextPath() %>/js/mouse_a/TweenMax.min.js'></script>
<script src='<%=request.getContextPath() %>/js/mouse_a/three.min.js'></script>
<script src="<%=request.getContextPath() %>/js/mouse_a/index.js"></script>
